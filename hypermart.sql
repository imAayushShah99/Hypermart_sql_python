...
-- Categorize sales into 3 group MORNING, AFTERNOON, EVENING. Find out each of the shift and number of invoices
...
-- Identify 5 branch with highest decrese ratio in revevenue compare to last year (current year 2023 and last year 2022)
SELECT 
	r_23.branch,
	r_23.revenue as revenue_23,
	r_22.revenue as revenue_22,
	ROUND((r_22.revenue-r_23.revenue)::numeric/r_22.revenue::numeric*100,2) as dec_ratio
FROM revenue_23 as r_23
JOIN revenue_22 as r_22 ON r_22.branch = r_23.branch
WHERE r_23.revenue < r_22.revenue
ORDER BY 4 desc
LIMIT 5
